...
class ImageNet():
    ...
    def __init__(self, root, num_shots, preprocess, train_preprocess=None, test_preprocess=None):
        ...
        self.train_x = datasets.ImageFolder(os.path.join(self.image_dir, 'train'), transform=train_preprocess)
        self.val = datasets.ImageFolder(os.path.join(self.image_dir, 'val'), transform=preprocess)
        # self.test = datasets.ImageFolder(os.path.join(self.image_dir, 'test'), transform=test_preprocess)
